...
const ContactForm= () =>{
	...
	const handleSubmit = (event) => {
		...
		setLoading(true);
		axios.post(URL+'/api/v1/save_contact_form', $("#frm_r_contact").serialize()).then(res=>{
			if(res['data'].status=='1'){
				document.getElementById("frm_r_contact").reset();
			}
	...
	return(
		<div>
			...
			<ReactBootstrap.Form id="frm_r_contact" noValidate action="" method="post" validated={validated} onSubmit={handleSubmit} >
				<div className="row" >
					<div className="col">
